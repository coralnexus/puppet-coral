...
class coral::params {
  ...
  # Common
  $auto_translate = module_param('auto_translate', false)
  ...
  case $::operatingsystem {
    debian, ubuntu : {
      ...
      # OS Ruby
      $ruby_dev_package_names = module_array('ruby_dev_package_names', ['ruby1.9.1-dev'])
      $ruby_package_names = module_array('ruby_package_names', ['ruby1.9.1'])
      ...
      $ruby_variables = deep_merge({
        'RUBYOPT' => 'rubygems',
        'GEM_HOME' => $gem_home,
        'GEM_PATH' => $gem_home
      }, module_hash('ruby_variables'))
      ...
      $puppet_dev_package_names = module_array('puppet_dev_package_names')
      ...
      $puppet_daemon_env = deep_merge({
        'DAEMON_OPTS' => ''
      }, module_hash('puppet_daemon_env'))
